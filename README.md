...
## Documentation
Please find the documentation in: https://fully-angular-admin-docs.angular-templates.io/
...
Run `npm run build:ssr && npm run serve:ssr` to build the project with SSR.
